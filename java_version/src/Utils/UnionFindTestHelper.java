...
public class UnionFindTestHelper {
    ...
    public static void testUF1(int n) {
        ...
        UnionFindId uf = new UnionFindId(n);
    ...
    public static void testUF3( int n ){
        ...
        UnionFindTreeSizeOptimized uf = new UnionFindTreeSizeOptimized(n);
    ...
    public static void testUF4( int n ){
        ...
        UnionFindTreeRankOptimized uf = new UnionFindTreeRankOptimized(n);
